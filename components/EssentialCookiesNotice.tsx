...
const EssentialCookiesNotice: React.FC<EssentialCookiesNoticeProps> = ({ onViewCookies }) => {
  ...
  return (
    ...
    >
      <div className="pointer-events-auto mx-auto max-w-3xl rounded-2xl border border-white/15 bg-slate-950/95 backdrop-blur-md shadow-2xl shadow-black/40 px-4 py-3 sm:px-5 sm:py-4 flex flex-col sm:flex-row sm:items-center gap-3 text-sm text-slate-200">
        ...
        <button
          type="button"
          onClick={dismiss}
          className="shrink-0 self-end sm:self-auto px-4 py-2 rounded-xl bg-indigo-500 text-white font-semibold hover:bg-indigo-400 transition"
        >

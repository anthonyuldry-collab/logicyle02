...
import { StaffRoleKeyString, getStaffRoleKey, isManagerEquivalentStaffRole } from './staffRoleUtils';
...
export const STAFF_ROLE_ACCESS: Record<StaffRoleKeyString, StaffRoleAccessProfile> = {
  ...
  OSTEOPATHE: {
    ...
    missionTabLabel: '',
    missionTabDescription: '',
    sectionDenials: [...BASE_OPERATIONAL_DENIALS, 'equipment', 'vehicles', 'stocks'],
    sectionGrants: {
      roster: ['view'],
      events: ['view'],
      myTrips: ['view', 'edit'],
    ...
    riderFields: ['photoUrl', 'healthCondition'],
    canEditEventMissionLogistics: false,
  },
  NUTRITIONNISTE: {
    roleKey: 'NUTRITIONNISTE',
  ...
  CHAUFFEUR: {
    ...
    missionTabLabel: '',
    missionTabDescription: '',
    sectionDenials: [...BASE_OPERATIONAL_DENIALS, 'roster', 'equipment', 'stocks'],
    sectionGrants: {
      vehicles: ['view'],
      events: ['view'],
      myTrips: ['view', 'edit'],
  ...
  CUISINIER: {
    ...
    riderFields: ['allergies', 'dietaryRegimen', 'foodPreferences'],
    canEditEventMissionLogistics: false,
  },
  HOSPITALITY: {
    roleKey: 'HOSPITALITY',
...
export function canViewOrganizerApplicationDossier(
  ...
  if (isManagerEquivalentStaffRole(staffMember.role)) return true;

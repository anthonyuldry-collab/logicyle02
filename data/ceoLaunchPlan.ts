...
export const CEO_PRELAUNCH_CHECKLIST: CeoChecklistItem[] = [
  // ——— Septembre 2026 ———
  {
    ...
    detailFr: 'Plans Club→Pro · grille 99→790 € · héros Compétition 2 490 €/an · essai 14/30 j · webhooks. Dossier : lancement/03.',
    detailEn: 'Club→Pro plans · €99–790 grid · Competition hero €2,490/yr · 14/30-day trial · webhooks. See lancement/03.',
    priority: 'P0',
  },
  {
    id: 'sept-statuts',
    ...
    detailFr: 'Objet SaaS · PI cédée à la société · pouvoirs · greffe/Kbis. Dossier : lancement/01.',
    detailEn: 'SaaS object · IP assigned to company · powers · registry/Kbis. See lancement/01.',
    priority: 'P0',
  },
  {
    id: 'sept-legal-pack',
  ...
  },
  {
    ...
    phase: 'sept',
    category: 'legal',
    titleFr: 'Marque INPI rovik + domaines verrouillés',
    titleEn: 'INPI trademark rovik + locked domains',
    detailFr: 'Recherche antériorité rovik · dépôt classes 9/42/35 · rovik.app/.com/.fr. Dossier : lancement/02.',
    detailEn: 'Prior art search for rovik · file classes 9/42/35 · lock rovik.app/.com/.fr. See lancement/02.',
    priority: 'P0',
  },
  {
    id: 'sept-pipeline-fr',
  ...
  },
  {
    ...
    phase: 'sept',
    category: 'ops',
    titleFr: 'MX contact@ / support@ / privacy@',
    titleEn: 'MX for contact@ / support@ / privacy@',
    detailFr: 'Redirection ImprovMX ou registrar · test d’envoi. lancement/04.',
    detailEn: 'ImprovMX or registrar forwarding · send a test. See lancement/04.',
    priority: 'P0',
  },
  {
    id: 'sept-backup',
    phase: 'sept',
    category: 'ops',
    titleFr: 'Backup Firestore planifié + restore test',
    titleEn: 'Scheduled Firestore backup + restore test',
    detailFr: 'Bucket GCS dédié · export quotidien ou hebdo · une restauration hors prod. lancement/06.',
    detailEn: 'Dedicated GCS bucket · daily or weekly export · one restore off-prod. See lancement/06.',
    priority: 'P0',
  },
  {
    id: 'sept-rebrand-prod',
    phase: 'sept',
    category: 'produit',
    titleFr: 'Déployer le front rovik en production',
    titleEn: 'Ship the rovik front to production',
    detailFr: 'Landing / login / PWA · smoke prod. lancement/08-deploy-rebrand.md.',
    detailEn: 'Landing / login / PWA · prod smoke. See lancement/08.',
    priority: 'P0',
  },
  ...
  // ——— Octobre 2026 ———
  {
    ...
    detailFr: 'Pitch wedge EN · 3 RDV · 1 essai 30 j Élite en discussion.',
    detailEn: 'EN wedge pitch · 3 meetings · 1× 30-day Elite trial in talk.',
    priority: 'P0',
  },
  {
    id: 'oct-rgpd',
  ...
  // ——— Novembre 2026 ———
  {
    ...
    detailFr: 'Stripe · statuts/Kbis · CGU/CGV live · EN · 3 clients prêts · backup Firebase. Visa : lancement/09-go-nogo.md.',
    detailEn: 'Stripe · articles/Kbis · ToS live · EN · 3 ready-to-pay · Firebase backup. Sign-off: lancement/09-go-nogo.md.',
    priority: 'P0',
  },
  {
    id: 'nov-pricing-page',
    phase: 'nov',
    category: 'commercial',
    titleFr: 'Page tarifs publique + CTA essai 14/30 j',
    titleEn: 'Public pricing page + 14/30-day trial CTA',

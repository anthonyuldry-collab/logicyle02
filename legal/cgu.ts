    ...
    },
    {
      ...
      blocks: {
        fr: [
          ...
          'Régime A — Prestation indépendante : le vacataire agit en travailleur indépendant (micro-entreprise, EI, société…). Lorsqu’un paiement in-app Stripe Connect est activé, LogiCycle agit comme intermédiaire de paiement (merchant of record) : l’Équipe paie LogiCycle ; LogiCycle reverse le net au vacataire après commission. Chaîne de facturation cible : (1) facture LogiCycle → Équipe pour le montant mission (GMV) ; (2) facture vacataire → LogiCycle pour le net (GMV moins commission). Les reçus Stripe ne remplacent pas ces factures.',
          ...
          'Aucun lien de subordination n’est créé entre LogiCycle et le vacataire. L’Équipe et le vacataire restent responsables de la qualification juridique exacte de la relation et du respect du droit du travail, du sport et des obligations fiscales / URSSAF. Un usage détourné du régime A pour masquer un salariat engage leur responsabilité ; LogiCycle peut suspendre l’accès Connect.',
          ...
          'Les litiges d’exécution (qualité, horaires, annulation) sont d’abord traités entre Équipe et vacataire. LogiCycle peut, sans obligation, faciliter une médiation.',
        ...
        en: [
          ...
          'Regime A — Independent contracting: the freelancer acts as an independent worker (sole trader, company, etc.). When in-app Stripe Connect payment is enabled, LogiCycle acts as payment intermediary (merchant of record): the Team pays LogiCycle; LogiCycle pays out the net to the freelancer after the platform fee. Target invoice chain: (1) LogiCycle → Team for the mission amount (GMV); (2) freelancer → LogiCycle for the net (GMV minus fee). Stripe receipts are not substitutes for those invoices.',
          ...
          'No employment relationship is created between LogiCycle and the freelancer. Team and freelancer remain responsible for the correct legal characterisation and for labour, sports, tax and social-security compliance. Misusing Regime A to disguise employment engages their liability; LogiCycle may suspend Connect access.',
          ...
          'Performance disputes (quality, hours, cancellation) are primarily between Team and freelancer. LogiCycle may, without obligation, facilitate mediation.',

...
export const CGU_DOCUMENT: LegalDocument = {
  ...
  summary: {
    fr: 'Règles d’accès et d’usage de la plateforme LogiCycle pour équipes, indépendants, staff, partenaires et vacataires.',
    en: 'Rules governing access to and use of the LogiCycle platform for teams, independents, staff, partners and freelancers.',
  },
  sections: [
    {
      id: 'object',
      ...
      blocks: {
        fr: [
          'Les présentes Conditions générales d’utilisation (« CGU ») régissent l’accès et l’utilisation de la plateforme SaaS LogiCycle (logiciel de gestion d’équipes cyclistes, logistique, performance, partenariats, scouting et marketplace de missions), accessible via le site et les applications associés (ci-après la « Plateforme »).',
          'L’éditeur est désigné « LogiCycle », « nous ». L’utilisateur est désigné « Utilisateur », « vous ». Le client abonné (club, équipe, fédération ou organisation) est désigné « Client » ou « Équipe ».',
        ...
        en: [
          'These Terms of Use (“ToU”) govern access to and use of the LogiCycle SaaS platform (cycling-team management, logistics, performance, partnerships, scouting and mission marketplace), available via the related website and apps (the “Platform”).',
          'The publisher is referred to as “LogiCycle” or “we”. The end user is the “User” or “you”. The subscribing customer (club, team, federation or organisation) is the “Customer” or “Team”.',
    ...
    },
    {
      ...
      blocks: {
        fr: [
          ...
          'LogiCycle peut suspendre ou clôturer un compte en cas de fausse identité, de violation des CGU, de risque sécurité, ou sur demande légitime du Client administrateur de l’Équipe.',
        ],
        en: [
          ...
          'LogiCycle may suspend or close an account for false identity, ToU breach, security risk, or upon legitimate request from the Team’s Customer administrator.',
        ],
      },
    },
    {
      ...
      blocks: {
        fr: [
          ...
          'LogiCycle fournit un outil technique. LogiCycle n’est pas l’employeur des Utilisateurs, ni le donneur d’ordre des vacataires marketplace, ni le conseiller juridique, médical ou fiscal du Client.',
        ...
        en: [
          ...
          'LogiCycle provides a technical tool. LogiCycle is not the Users’ employer, not the contracting principal of marketplace freelancers, and not the Customer’s legal, medical or tax adviser.',
    ...
    },
    {
      ...
      blocks: {
        fr: [
          ...
          '• traiter des données de santé, de mineurs ou de scouting sans base légale et, le cas échéant, sans consentement requis ;',
          ...
          'Le scouting et les profils indépendants doivent reposer sur des informations loyales ; le retrait du consentement (lorsqu’applicable) doit être respecté.',
        ],
        en: [
          'You must not:',
          ...
          '• process health, minor or scouting data without a lawful basis and any required consent;',
          ...
          'Scouting and independent profiles must be based on fair information; withdrawal of consent (where applicable) must be honoured.',
        ],
      },
    },
    {
      ...
      blocks: {
        fr: [
          'La marketplace met en relation des Équipes (donneurs d’ordre) et des vacataires / indépendants (prestataires). LogiCycle agit comme intermédiaire technique de mise en relation. Le paiement in-app via Stripe Connect n’est pas encore activé : les règlements se font hors plateforme entre les parties, sous leur seule responsabilité.',
          'Le vacataire agit en prestataire indépendant. Aucun lien de subordination n’est créé avec LogiCycle. L’Équipe demeure seule responsable de la qualification juridique de la mission, des obligations sociales/fiscales applicables et du respect du droit du travail / sport.',
          'Lorsque le paiement in-app sera activé, une commission plateforme pourra s’appliquer (grille indicative : 12 % du GMV vacataire sur Compétition / Continental ; 10 % sur Pro ; minimum / plafond publiés). Les CGV préciseront alors les conditions de facturation.',
          'Les litiges relatifs à l’exécution d’une mission (qualité, horaires, annulation) sont d’abord traités entre Équipe et vacataire. LogiCycle peut, sans obligation, faciliter la médiation.',
          'L’accès à la publication de missions dépend du plan d’abonnement (voir CGV et documentation commerciale).',
        ],
        en: [
          'The marketplace connects Teams (clients) and freelancers / independents (providers). LogiCycle acts as a technical matching intermediary. In-app payment via Stripe Connect is not enabled yet: settlements happen off-platform between the parties, under their sole responsibility.',
          'The freelancer acts as an independent contractor. No employment relationship is created with LogiCycle. The Team alone is responsible for the legal characterisation of the engagement, applicable social/tax duties and labour / sports law compliance.',
          'When in-app payments are enabled, a platform commission may apply (indicative schedule: 12% of freelancer GMV on Competition / Continental; 10% on Pro; published minimums / caps). The Terms of Sale will then set billing terms.',
          'Disputes about mission performance (quality, hours, cancellation) are primarily between Team and freelancer. LogiCycle may, without obligation, facilitate mediation.',
          'Mission publishing depends on the subscription plan (see Terms of Sale and commercial documentation).',
        ],
      },
    },
    {
      ...
      blocks: {
        fr: [
          'La Plateforme, son code, interfaces, marques, logos, documentation, modèles et savoir-faire restent la propriété exclusive de LogiCycle ou de ses concédants. Aucune cession de droits n’est opérée hors licence d’usage limitée, non exclusive, non cessible, pour la durée de l’accès autorisé.',
          'Les contenus et données Client restent la propriété du Client. Le Client concède à LogiCycle une licence mondiale, limitée, pour héberger, traiter, sauvegarder et afficher ces contenus uniquement afin de fournir le service.',
        ...
        en: [
          'The Platform, its code, interfaces, trademarks, logos, documentation, templates and know-how remain the exclusive property of LogiCycle or its licensors. No IP assignment occurs beyond a limited, non-exclusive, non-transferable licence for the duration of authorised access.',
          'Customer content and data remain Customer property. The Customer grants LogiCycle a worldwide, limited licence to host, process, back up and display that content solely to provide the service.',
    ...
    },
    {
      ...
      blocks: {
        fr: [
          'L’Utilisateur s’engage à ne pas divulguer, reproduire ou exploiter commercialement les informations non publiques de LogiCycle (interfaces non publiées, algorithmes, roadmap, tarifs non publics, données techniques, contenus d’autres équipes auxquels il n’a pas droit).',
          ...
          'Les obligations ne portent pas sur les informations déjà publiques, reçues licitement d’un tiers sans devoir de confidentialité, ou exigées par la loi / une autorité (avec information préalable de LogiCycle lorsque cela est légalement possible).',
        ],
        en: [
          'The User agrees not to disclose, reproduce or commercially exploit LogiCycle’s non-public information (unpublished interfaces, algorithms, roadmap, non-public pricing, technical data, or other teams’ content without entitlement).',
          ...
          'It does not cover information that is already public, lawfully received from a third party without a duty of confidence, or required by law / authority (with prior notice to LogiCycle where legally permitted).',
        ],
      },
    },
    {
      ...
      blocks: {
        fr: [
          'LogiCycle s’efforce d’assurer une disponibilité raisonnable de la Plateforme (objectif indicatif 99 % hors maintenance planifiée et cas de force majeure), sans garantie absolue de continuité ininterrompue sauf SLA Enterprise écrit.',
          ...
          'LogiCycle peut modifier les présentes CGU. La version applicable est celle affichée sur /legal/cgu avec son numéro de version. Les changements matériels seront notifiés (email ou in-app) avec un préavis raisonnable lorsque la loi l’exige.',
        ],
        en: [
          'LogiCycle endeavours to provide reasonable Platform availability (indicative 99% target excluding planned maintenance and force majeure), without an absolute uptime warranty unless a written Enterprise SLA applies.',
          'Maintenance may be scheduled; features may evolve. Beta features are provided “as is”, with no availability commitment.',
          'LogiCycle may amend these ToU. The applicable version is the one shown at /legal/cgu with its version number. Material changes will be notified (email or in-app) with reasonable notice where required by law.',
        ],
      },
    },
    {
      ...
      blocks: {
        fr: [
          ...
          'Dans les limites permises par la loi, LogiCycle n’est pas responsable des dommages indirects (perte de chance, manque à gagner, perte de données non imputable à une faute grave de LogiCycle, atteinte à l’image).',
          'La responsabilité totale de LogiCycle au titre des CGU, pour tout fait générateur, est plafonnée au montant des redevances effectivement payées par le Client à LogiCycle au cours des douze (12) mois précédant le fait générateur (ou, pour un Utilisateur sans abonnement propre, à 100 €).',
        ...
        en: [
          ...
          'To the fullest extent permitted by law, LogiCycle is not liable for indirect damages (loss of opportunity, lost profits, data loss not caused by LogiCycle’s gross negligence, reputational harm).',
          'LogiCycle’s aggregate liability under the ToU for any claim is capped at the fees actually paid by the Customer to LogiCycle in the twelve (12) months preceding the claim (or, for a User without their own subscription, €100).',
    ...
    },
    {
      ...
      blocks: {
        fr: [
          ...
          'En cas de violation grave, LogiCycle peut suspendre immédiatement l’accès et, après notification, supprimer le compte.',
        ...
        en: [
          ...
          'For serious breach, LogiCycle may immediately suspend access and, after notice, delete the account.',

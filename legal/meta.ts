...
export const LEGAL_ENTITY = {
  ...
  privacyEmail: 'privacy@logicycle.fr',
  contactEmail: 'contact@logicycle.fr',
  supportEmail: 'support@logicycle.fr',
  dpoEmail: 'privacy@logicycle.fr',
  website: 'https://logicycle.fr',
  governingLaw: {
    fr: 'droit français',
    en: 'French law',
  },

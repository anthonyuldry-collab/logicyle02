...
export const DPA_DOCUMENT: LegalDocument = {
  ...
  summary: {
    fr: 'Cadre contractuel lorsque LogiCycle traite des données personnelles pour le compte du Client Équipe.',
    en: 'Contractual framework when LogiCycle processes personal data on behalf of the Customer Team.',
  },
  sections: [
    {
      id: 'parties',
      ...
      blocks: {
        fr: [
          'Le présent Accord de sous-traitance (« DPA ») est conclu entre le Client (responsable de traitement) et LogiCycle (sous-traitant) pour les traitements réalisés via la Plateforme sur instruction du Client.',
        ...
        en: [
          'This Data Processing Agreement (“DPA”) is between the Customer (controller) and LogiCycle (processor) for processing via the Platform on the Customer’s instructions.',
    ...
    },
    {
      ...
      blocks: {
        fr: [
          'Objet : hébergement et fourniture des modules LogiCycle (gestion d’équipe, performance, logistique, finances, partenariats, scouting, marketplace liée à l’équipe).',
        ...
        en: [
          'Subject matter: hosting and provision of LogiCycle modules (team management, performance, logistics, finance, partnerships, scouting, team-related marketplace).',
    ...
    },
    {
      ...
      blocks: {
        fr: [
          'LogiCycle ne traite les Données Client que sur instruction documentée du Client : usage de la Plateforme, CGU/CGV/DPA, et demandes écrites (email) compatibles avec le service.',
          'Si une instruction paraît illicite au regard du RGPD, LogiCycle en informe le Client sans exécuter l’instruction contestée, sauf obligation légale contraire.',
        ...
        en: [
          'LogiCycle processes Customer Data only on documented Customer instructions: Platform use, ToU/ToS/DPA, and written requests (email) compatible with the service.',
          'If an instruction appears unlawful under the GDPR, LogiCycle will inform the Customer and will not execute the contested instruction unless legally required otherwise.',
    ...
    },
    {
      ...
      blocks: {
        fr: [
          ...
          'LogiCycle notifie le Client sans délai injustifié après avoir pris connaissance d’une violation de données personnelles affectant les Données Client, avec les informations raisonnablement disponibles pour permettre au Client de respecter l’art. 33/34.',
        ],
        en: [
          ...
          'LogiCycle notifies the Customer without undue delay after becoming aware of a personal-data breach affecting Customer Data, with information reasonably available to help the Customer meet Art. 33/34 duties.',
        ],
      },
    },
    {
      ...
      blocks: {
        fr: [
          ...
          'LogiCycle peut ajouter un sous-traitant en informant le Client (email ou page /legal/dpa) avec un préavis de 15 jours. Objection motivée : le Client peut résilier le module concerné ou l’abonnement si l’objection est raisonnable et qu’aucune alternative n’est trouvée.',
          'LogiCycle impose à ses sous-traitants des obligations de protection équivalentes.',
        ],
        en: [
          ...
          'LogiCycle may add a sub-processor by notifying the Customer (email or /legal/dpa) with 15 days’ notice. Motivated objection: the Customer may terminate the affected module or subscription if the objection is reasonable and no alternative is found.',
          'LogiCycle imposes equivalent protection obligations on its sub-processors.',
        ],
      },
    },
    {
      ...
      blocks: {
        fr: [
          'LogiCycle assiste le Client, dans la mesure du raisonnable et via les fonctions produit, pour : demandes des personnes, sécurité, notifications de violation, analyses d’impact (AIPD) lorsque le traitement le justifie, et audits.',
        ...
        en: [
          'LogiCycle assists the Customer, reasonably and via product features, with: data-subject requests, security, breach notices, DPIAs when warranted, and audits.',
    ...
    },
    {
      ...
      blocks: {
        fr: [
          'Tout transfert hors EEE s’appuie sur un mécanisme valide (clauses contractuelles types, décision d’adéquation, Data Privacy Framework, etc.). Sur demande, LogiCycle fournit les références des CCT applicables avec Google / Stripe.',
        ],
        en: [
          'Any transfer outside the EEA relies on a valid mechanism (SCCs, adequacy decision, Data Privacy Framework, etc.). On request, LogiCycle provides references to applicable SCCs with Google / Stripe.',
        ],
      },
    },
    {
      ...
      blocks: {
        fr: [
          'À la fin du service, le Client peut exporter ses données. Ensuite, LogiCycle supprime ou anonymise les Données Client personnelles dans un délai indicatif de 30 jours, sauf conservation imposée par la loi ou nécessaire à la défense d’un droit en justice (durée limitée).',
          'Certification de suppression disponible sur demande écrite raisonnable.',
        ],
        en: [
          'At service end, the Customer may export its data. LogiCycle then deletes or anonymises personal Customer Data within an indicative 30 days, except retention required by law or needed to establish/defend legal claims (limited period).',
